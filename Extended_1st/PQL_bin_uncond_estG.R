...
p3
ggsave("uncond_bin_fixedhist_estG.pdf", width = 7, height = 7)
...
p4
ggsave("uncond_bin_randhist_estG.pdf", width = 7, height = 7)

frobenius_norm %>% xtable %>% print

diff_norm %>% xtable %>% print

save(diff_norm, file = "uncond_bin_PQLvsLA_estG.Rdata")
