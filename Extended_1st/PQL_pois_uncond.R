...
p1
ggsave("uncond_pois_coverage.pdf", width = 7, height = 7)
...
p2
ggsave("uncond_pois_shapiro.pdf", width = 7, height = 7)
...
p3
ggsave("uncond_pois_fixedhist.pdf", width = 7, height = 7)
...
p4
ggsave("uncond_pois_randhist.pdf", width = 7, height = 7)

frobenius_norm %>% xtable %>% print

diff_norm %>% xtable %>% print

save(diff_norm, file = "uncond_pois_PQLvsLA.Rdata")

save(coverages,PQLshapiros, file = "uncond_pois.Rdata")
