...
p1
ggsave("cond_pois_coverage.pdf", width = 7, height = 7)
...
p2
ggsave("cond_pois_shapiro.pdf", width = 7, height = 7)
...
p3
ggsave("cond_pois_fixedhist.pdf", width = 7, height = 7)
...
p4
ggsave("cond_pois_randhist.pdf", width = 7, height = 7)

diff_norm %>% xtable %>% print

save(diff_norm, file = "cond_pois_PQLvsLA.Rdata")

save(coverages,PQLshapiros, file = "cond_pois.Rdata")
