...
p1
ggsave("cond_bin_coverage_estG.pdf", width = 7, height = 7)
...
p2
ggsave("cond_bin_shapiro_estG.pdf", width = 7, height = 7)
...
p3
ggsave("cond_bin_fixedhist_estG.pdf", width = 7, height = 7)
...
p4
ggsave("cond_bin_randhist_estG.pdf", width = 7, height = 7)



diff_norm %>% xtable %>% print

save(diff_norm, file = "cond_bin_PQLvsLA_estG.Rdata")

save(coverages,PQLshapiros, file = "cond_bin_estG.Rdata")
